...
class BleManager @Inject constructor(
    ...
    companion object {
        val BLIP_SERVICE_UUID: UUID = UUID.fromString("0000BLIP-0000-1000-8000-00805F9B34FB")
        val BLIP_CHAR_UUID: UUID    = UUID.fromString("0001BLIP-0000-1000-8000-00805F9B34FB")
